package com.homework.hsj.zigbanghomework.activity;
...
public class MapsActivity extends FragmentActivity implements Ui, OnMapReadyCallback, MapsPresenter.MapsUi {

    private GoogleMap mMap;
    private MapsPresenter mapsPresenter = null;
    ...
    protected void onDestroy() {
        super.onDestroy();
        mapsPresenter.onUiUnready(this);
        mapsPresenter = null;
    }
